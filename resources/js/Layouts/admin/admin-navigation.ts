...
const RAW_NAV_DEFS: RawNavGroup[] = [
    ...
    },
    {
        ...
        items: [
            ...
            { label: 'Sauvegardes', path: 'backups', icon: HardDrive },
            { label: 'Import / Export', path: 'import-export', icon: ArrowDownUp },
            { label: 'Assistant IA', path: 'ai/settings', icon: Sparkles, requiresPlugin: 'ai-assistant' },
            { label: 'Mises a jour', path: 'updates', icon: Wrench },
            { label: 'Prise en main', path: 'onboarding', icon: LifeBuoy },
        ],
    },
    {
        title: 'Apparence',
    ...
    },
    {
        ...
        items: [
            ...
            { label: 'Activite', path: 'activity-log', icon: Activity },
            { label: 'Notifications', path: 'notifications', icon: Bell },
            { label: 'Sessions', path: 'system/sessions', icon: MonitorCheck },
            { label: 'Etat systeme', path: 'system/health', icon: HardDrive },
            { label: 'Performance', path: 'system/performance', icon: Gauge },
            { label: 'Queues', path: 'system/queues', icon: ListChecks },
            { label: 'Scheduler', path: 'system/scheduler', icon: CalendarDays },
