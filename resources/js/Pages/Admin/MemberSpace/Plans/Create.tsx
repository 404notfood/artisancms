            ...
            <form onSubmit={handleSubmit} className="mx-auto max-w-2xl space-y-6">
                ...
                <div className="rounded-lg border border-gray-200 bg-white p-6 space-y-4">
                    ...
                    <div className="flex gap-2">
                        <input
                            ...
                            placeholder="Ex: Acces illimite aux articles"
                        />
                        <button type="button" onClick={addFeature} className="rounded-lg bg-gray-100 px-3 py-2 text-sm font-medium text-gray-700 hover:bg-gray-200">
                            Ajouter
                        </button>
                    </div>
                ...
                <div className="rounded-lg border border-gray-200 bg-white p-6 space-y-4">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="text" value={data.badge_label} onChange={(e) => setData('badge_label', e.target.value)} className={inputClass} placeholder="Populaire" />
                        </div>
                        <div>
                ...
                <div className="flex justify-end">
                    <button type="submit" disabled={processing} className="rounded-lg bg-indigo-600 px-6 py-2 text-sm font-medium text-white hover:bg-indigo-700 disabled:opacity-50">
                        {processing ? 'Creation...' : 'Creer le plan'}
                    </button>
                </div>
            </form>
        </AdminLayout>
