...
export default function CustomFieldsCreate({ fieldTypes }: Props) {
    const [fields, setFields] = useState<FieldEntry[]>([createEmptyField(0)]);
    ...
    const handleFormSubmit = (e: React.FormEvent) => {
        ...
        // Post directly with merged data
                ...
                <div className="rounded-lg border border-gray-200 bg-white p-6 space-y-4">
                    ...
                    <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                        <div>
                            ...
                            <input
                                ...
                                placeholder="Ex : Détails produit"
                    ...
                    <div>
                        ...
                        <textarea
                            ...
                            rows={2}
                            placeholder="Description optionnelle pour ce groupe de champs..."
                            className="mt-1 block w-full rounded-lg border border-gray-300 px-3 py-2 text-sm focus:border-indigo-500 focus:outline-none focus:ring-1 focus:ring-indigo-500"
                        />
                        {errors.description && (
