                    ...
                    <div className="rounded-xl border border-gray-200 bg-white p-8">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-4">
                            <input
                                ...
                                className="block w-full rounded-lg border border-gray-300 px-3 py-3 text-center text-lg tracking-widest focus:border-indigo-500 focus:outline-none focus:ring-1 focus:ring-indigo-500"
                                autoFocus
                                required
                            />
