...
class MenuItemsRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'items.*.is_mega' => ['sometimes', 'boolean'],
            'items.*.mega_columns' => ['sometimes', 'integer', 'min:2', 'max:5'],
            'items.*.mega_image' => ['nullable', 'string', 'max:2048'],
            'items.*.mega_html' => ['nullable', 'string', 'max:10000'],
            'items.*.mega_width' => ['sometimes', 'string', Rule::in(['auto', 'full', 'fixed'])],
