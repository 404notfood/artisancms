...
class MenuController extends Controller
{
    ...
    public function updateItem(Request $request, Menu $menu, MenuItem $item): RedirectResponse
    {
        $validated = $request->validate([
            ...
            'mega_columns' => ['sometimes', 'integer', 'min:2', 'max:5'],
            'mega_image' => ['nullable', 'string', 'max:2048'],
            'mega_html' => ['nullable', 'string', 'max:10000'],
            'mega_width' => ['sometimes', 'in:auto,full,fixed'],
